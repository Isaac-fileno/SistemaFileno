 ...
 * @author zfabi
 */
public class JFrmIffPrincipal extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(JFrmIffPrincipal.class.getName());

    /**
     * Creates new form JFrmPtePrincipal
     */
    public JFrmIffPrincipal() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jMniFornecedores.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/correio.png"))); // NOI18N
        ...
        jMniJogos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/controle-de-video-game (1).png"))); // NOI18N
        ...
        jMniVendas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/etiqueta-de-venda.png"))); // NOI18N
        ...
        jMniCompras.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/carrinho-de-compras.png"))); // NOI18N
    ...
    private void jMniUsuariosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMniUsuariosActionPerformed
        ...
        JDlgIffUsuarios jDlgIffUsuarios = new JDlgIffUsuarios(null, true);
        jDlgIffUsuarios.setVisible(true);
    ...
    private void jMniClientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMniClientesActionPerformed
        // TODO add your handling code here:
        JDlgIffClientes jDlgIffClientes = new JDlgIffClientes(null, true);
        jDlgIffClientes.setVisible(true);
    ...
    private void jMniFornecedoresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMniFornecedoresActionPerformed
        // TODO add your handling code here:
        JDlgIffFornecedor jDlgIffFornecedor = new JDlgIffFornecedor(null, true);
        jDlgIffFornecedor.setVisible(true);
    ...
    private void jMniJogosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMniJogosActionPerformed
        // TODO add your handling code here:
        JDlgIffJogos jDlgIffJogos = new JDlgIffJogos(null, true);
        jDlgIffJogos.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new JFrmIffPrincipal().setVisible(true));
    }
